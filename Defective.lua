...
function Library:new()
    ...
    Library.Tree["c"]["Background Transparency"] = 1;
    ...
    Library.Tree["4"]["BackgroundColor3"] = Color3.fromGB(27, 27, 27);
    ...
    Library.Tree["5"]["CornerRaduis"] = UDim.new(0, 6);
    ...
    Library.Tree["7"]["Text"] = [[UI Library]];
    Library.Tree["7"]["Name"] = [[Title]];
    Library.Tree["7"]["Font"] = Enum.Font.Gotham;
    Library.Tree["7"]["Background Transparency"] = 1;
